    ...
    def generate_marketing_data(self, restaurants):
        ...
        for restaurant in restaurants:
            ...
            for i in range(num_campaigns):
                ...
                marketing_budget = round(random.uniform(
                    5000, 20000), 2)  # Keep budget high
                marketing_cost = round(random.uniform(
                    500, 2000), 2)  # Keep cost low
                ...
                campaign_start_date = fake.date_between(
                    start_date='-1y', end_date='today')
                campaign_end_date = fake.date_between(
                    start_date=campaign_start_date, end_date='today')
                marketing_data = {
                    'Restaurant_UID': restaurant_id,
